...
"""
Reduced Mean Range (RMR) indicates the range of values across
all inlets surveyed for each depth level. Note that it does NOT
provide any information on per-inlet variability of measurements.
"""
PLOT_RMR = False
